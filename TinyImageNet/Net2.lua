...
--     local FC39   = net.modules[39]
    ...
    local level_3_deconv = nn.SpatialFullConvolution(128, 16, 1, 1, 2, 2, 0, 0, 1, 1)(level_3):annotate{
       name = 'Deconving level 3', description = 'To increase the dimension',
       graphAttributes = {color = 'yellow'}
    }
    local level_6_deconv = nn.SpatialFullConvolution(256, 16, 2, 2, 4, 4, 0, 0, 2, 2)(level_6):annotate{
    ...
    local level_6point5 = nn.SpatialBatchNormalization(32)( nn.SpatialConvolution(99, 32, 3, 3, 1, 1, 1, 1)(output_VGG))
    ...
    local level_9= nn.Sigmoid()( nn.SpatialConvolution(64, 2, 3, 3, 1, 1, 1, 1)(level_8)):annotate{
